...
sf_origin_distances <- st_distance(sf_origin$closest_point_on_line, by_element = FALSE) 
sf_dest_distances <- st_distance(sf_dest$closest_point_on_line, by_element = FALSE) 
